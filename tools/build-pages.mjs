        ...
        <form class="glass contact-form reveal d2" id="contactForm" novalidate>
          <div class="form-row">
            <div class="field">
              ...
              <input id="fName" name="name" type="text" required minlength="2" maxlength="80" autocomplete="name" placeholder="Az Ön neve" data-i18n="form.name_ph" data-i18n-attr="placeholder">
            </div>
            <div class="field">
              <label for="fPhone" data-i18n="form.phone">Telefon *</label>
              <input id="fPhone" name="phone" type="tel" required inputmode="tel" pattern="[0-9+()/ .\\-]{6,20}" minlength="6" maxlength="30" autocomplete="tel" placeholder="+36 …">
            </div>
          </div>
          <div class="field">
            <label for="fEmail" data-i18n="form.email">E-mail *</label>
            <input id="fEmail" name="email" type="email" required maxlength="120" autocomplete="email" placeholder="pelda@email.hu" data-i18n="form.email_ph" data-i18n-attr="placeholder">
          </div>
          <div class="field">
          ...
          <div class="field">
            ...
            <textarea id="fMsg" name="message" rows="4" required minlength="5" maxlength="2000" placeholder="Írja le röviden, miben segíthetünk…" data-i18n="form.message_ph" data-i18n-attr="placeholder"></textarea>
          </div>
          <!-- Spam-csapda: valódi látogató nem látja és nem tölti ki (rejtett) -->
          <div class="hp-field" aria-hidden="true">
            <label for="fWebsite">Weboldal (ne töltse ki)</label>
